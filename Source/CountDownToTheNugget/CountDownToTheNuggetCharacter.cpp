...
//////////////////////////////////////////////////////////////////////////
// ACountDownToTheNuggetCharacter

ACountDownToTheNuggetCharacter::ACountDownToTheNuggetCharacter()
{
	// Set size for collision capsule
	GetCapsuleComponent()->InitCapsuleSize(90.f, 100.0f);
...
void ACountDownToTheNuggetCharacter::BeginPlay()
{
	// Call the base class  
	Super::BeginPlay();
...
void ACountDownToTheNuggetCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
...
void ACountDownToTheNuggetCharacter::Move(const FInputActionValue& Value)
{
	// input is a Vector2D
...
void ACountDownToTheNuggetCharacter::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
